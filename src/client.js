...
let Bike = React.createClass({
    render: () => {
        let description = "SECONDS AT THE START GATE FEEL LIKE AN ETERNITY\. MIND AND BODY ARE PULSING \— IN PERFECT SYNC\. YOUR LINE GIVES YOU THE EDGE YOU NEED\. YOUR BIKE WILL HELP YOU STICK IT\.";
...
let Characters = React.createClass({
    ...
    render: function() {
        let bikes = ['pic/bike1.png', 'pic/bike2.png', 'pic/bike3.png'];
        ...
        return (
            <section id="characters">
                <div className="row">
                    ...
                    <h2>specifications: { specs[this.state.activeTab - 1].name }</h2>
                    { specsJsx }
                </div>
            </section>
        );
        ...
        return (
            <footer>
                <div className="row">
                    ...
                    <p>© 2016 Norco Bicycles | Use of this site constitutes acceptance of our Privacy Policy</p>
                </div>
            </footer>
        );
    }
